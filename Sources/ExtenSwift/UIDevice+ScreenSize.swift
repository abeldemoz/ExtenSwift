...
public extension UIDevice {
    enum ScreenSize {
        fileprivate static let width = UIScreen.main.bounds.size.width
        fileprivate static let height = UIScreen.main.bounds.size.height
        ...
        fileprivate static let minLength = min(width, height)
        fileprivate static let maxLength = max(width, height)



        // MARK: - Preferred Properties
        // These properties are intended to replace the deprecated properties.
        public static let is4InchesOrSmaller = ScreenSize.width <= 320.0 && ScreenSize.height <= 568.0
        public static let is4Point7InchesOrSmaller = ScreenSize.width <= 375.0 && ScreenSize.height <= 667
        ...
        public static let is4Inches = ScreenSize.width == 320.0 && ScreenSize.height == 568.0

        // 4.7-inch devices: iPhone 6, 6S, 7, 8, SE (2nd & 3rd gen)
        public static let is4Point7Inches = ScreenSize.width == 375.0 && ScreenSize.height == 667.0

        // 5.5-inch devices: iPhone 6 Plus, 6S Plus, 7 Plus, 8 Plus
        public static let is5Point5Inches = ScreenSize.width == 414.0 && ScreenSize.height == 736.0
        ...
        public static let is6Point1Inches3X = ScreenSize.width == 390.0 && ScreenSize.height == 844.0
        ...
        public static let is6Point7Inches = ScreenSize.width == 428.0 && ScreenSize.height == 926.0
    }
    ...
    static let isIpadMini: Bool = isIpad && ScreenSize.width <= 768
    ...
    static let isIPhone8OrSmaller = UIDevice.current.userInterfaceIdiom == .phone && ScreenSize.width <= 375
